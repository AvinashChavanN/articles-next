...
function middleware(_ref) {
  var req, res;
  return _regenerator["default"].async(function middleware$(_context) {
    while (1) {
  ...
  (0, _createClass2["default"])(Document, [{
    ...
    */
    value: function getInitialProps(ctx) {
      ...
      return _regenerator["default"].async(function getInitialProps$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              _context2.next = 11;
              return _regenerator["default"].awrap(ctx.renderPage({
